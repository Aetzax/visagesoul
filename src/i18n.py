...
TRANSLATIONS: Dict[str, Dict[str, str]] = {
    "es": {
        ...
        "chk_screen_flash": "Flash de pantalla al autenticar (Screen Fill Light)",
        "chk_screen_flash_tooltip": "Aumenta temporalmente el brillo del monitor para iluminar el rostro y la mano en habitaciones oscuras.",
        "screen_flash_boost_label": "Aumento de brillo en flash (10% - 50%):",
    ...
    "en": {
        ...
        "chk_screen_flash": "Screen Fill Light during authentication",
        "chk_screen_flash_tooltip": "Temporarily increases monitor brightness to illuminate face and hand in dark rooms.",
        "screen_flash_boost_label": "Screen flash brightness boost (10% - 50%):",
