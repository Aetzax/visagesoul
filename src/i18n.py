...
TRANSLATIONS: Dict[str, Dict[str, str]] = {
    "es": {
        ...
        "chk_thumbs_up": "Exigir gesto físico para confirmar el desbloqueo (2FA)",
        "gesture_type_label": "Gesto requerido:",
        "gesture_opt_thumb": "👍 Pulgar arriba",
        "gesture_opt_palm": "🖐️ Mano abierta",
        "gesture_opt_both": "🔄 Ambos (Pulgar arriba o Mano abierta)",
    ...
    "en": {
        ...
        "chk_thumbs_up": "Require physical hand gesture to confirm authentication (2FA)",
        "gesture_type_label": "Required gesture:",
        "gesture_opt_thumb": "👍 Thumbs up",
        "gesture_opt_palm": "🖐️ Open palm",
        "gesture_opt_both": "🔄 Both (Thumbs up or Open palm)",
