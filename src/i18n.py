...
TRANSLATIONS: Dict[str, Dict[str, str]] = {
    "es": {
        ...
        "welcome_status": "⚡ Pantalla de Bienvenida (SDDM):",
        "welcome_bypassed": "[OMITIDA - ESCANEO FACIAL DIRECTO]",
        "welcome_standard": "[ESTÁNDAR - PULSAR ENTER]",
        ...
        "chk_bypass_welcome": "Omitir pantalla de bienvenida (Bypass Welcome Page)",
        "chk_bypass_welcome_tooltip": "Inicia la sesión directamente y activa la cámara facial en la pantalla de bloqueo de inmediato sin pulsar teclas.",
        ...
        "lock_msg_group": "Mensajes y Retroalimentación Visual",
        ...
        "chk_cursor_feedback": "Animación en el puntero del ratón (Cursor Feedback)",
        "chk_cursor_feedback_tooltip": "Muestra el icono animado de VisageSoul junto al cursor del ratón mientras la cámara está verificando.",
        "chk_osd_notify": "Notificación OSD emergente al autenticar",
        "chk_osd_notify_tooltip": "Muestra un aviso emergente discreto en el escritorio indicando que se está esperando la biometría.",
    ...
    "en": {
        ...
        "welcome_status": "⚡ Welcome Screen (SDDM):",
        "welcome_bypassed": "[BYPASSED - DIRECT FACE SCAN]",
        "welcome_standard": "[STANDARD - PRESS ENTER]",
        ...
        "chk_bypass_welcome": "Bypass Welcome Page (Hands-free login)",
        "chk_bypass_welcome_tooltip": "Automatically logs in via SDDM and triggers the face lock screen immediately on boot without touching any keys.",
        ...
        "lock_msg_group": "Messages & Visual Feedback",
        ...
        "chk_cursor_feedback": "Animated bouncing cursor feedback",
        "chk_cursor_feedback_tooltip": "Shows the animated VisageSoul icon next to the mouse cursor while verifying.",
        "chk_osd_notify": "Desktop OSD notification banner",
        "chk_osd_notify_tooltip": "Displays a subtle desktop banner indicating biometric authentication is active.",
