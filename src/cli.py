...
def cmd_test(args):
    ...
    while True:
        ...
        hud_line1 = f"IA Anti-Spoof: Real {p_real*100:.0f}% | Pantalla {p_screen*100:.0f}% | Rigidez 3D: {rigidity:.5f} (req >= 0.015)"
        hud_line2 = f"Dinamica Ocular: {eye_std:.5f} (req >= 0.002) | Consenso: {consecutive_test_matches}/6 | Gesto: {gesture_name}"
